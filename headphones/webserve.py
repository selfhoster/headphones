...
class WebInterface(object):
    ...
    def config(self):
        ...
        config = {
            ...
            "deezloader_host": checked(headphones.CONFIG.DEEZLOADER_HOST),
            ...
            "torrent_downloader_deezloader": radio(headphones.CONFIG.TORRENT_DOWNLOADER, 5),
    ...
    def configUpdate(self, **kwargs):
        ...
        checked_configs = [
            ...
            "use_nzbsorg", "use_omgwtfnzbs", "use_piratebay", "use_oldpiratebay", "use_deezer",
